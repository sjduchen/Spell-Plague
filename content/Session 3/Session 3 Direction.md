...
What is driving players: 
1) Current: A return to Waylain to work on aiding Starleaf.
2) Original: Finding how to further aid Seldar.
3) New: Finding how to restore Mystryl to her true power 

How are the players enabled to follow a path:
1) [[Starleaf]] is waiting at [[Waylain]] -> both Seldar and Mystryl Path. 
...
What happens if the players follow a path:
	1) Starleaf will be able to move freely to the site of sundering with the party welcome to join. -> they must make their way deep into the shadow weave and find earth at the center to plant the tree. -> Primus and his army will make it to the final battle.  
	2) Khelben will send the party to the pathway of magical oddities to find the Crown of Karsus and disrupt an incredibly powerful force (The invasion of Modrones) -> Primus will be slowed, it's army weakened. Starleaf and Fflar will not be present for the battle. 
	3) Larloch will suggest the party head to the Knotted Lands to further aid Mystryl, he can tell there are remnants of her power there but others are present as well. 


How do characters react to Mystra being a fragment of Mystryl:
	1) Khelben - hesitant and doubtful. Driven by a fear of losing his god and a deep concern regarding why now after thousands of years and multiple rebirths this is happening. 
	2) Starleaf - Intrigued but mostly as a backup plan, wonders if Mystryl would be able to restore the elves to what they once were. 
	3) Fflar - Disinterested, hes focused on protecting Starleaf and her mission
	4) Seldar - Highly interested in this knowledge and willing to pause his motivations to find out more. Skeptical of the cyclical aspect but acknowledges that it would make more sense if the Mystras cycles are incomplete because of this. 
